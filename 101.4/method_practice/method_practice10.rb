...
munsters_answer  = { "Herman" => { "age" => 32, "gender" => "male", "age_group" => "adult" },
...
munsters.each do |k, v|
  v2 = munsters[k]["age"]
  case v2
  when 0..17 then v['age_group'] = 'kid'
  when 18..64 then v['age_group'] = 'adult'
  when 65..Float::INFINITY then v['age_group'] = 'senior'
  end
end

p munsters
p munsters == munsters_answer
